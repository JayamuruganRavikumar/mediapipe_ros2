...
class PosePublisher(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(Image, '/rgb_to_depth/image_raw', self.getimage_callback, 10)
    ...
    def getimage_callback(self, msg):
        ...
        with mp_pose.Pose(
            ...
            image = cv2.cvtColor(cv2.flip(image_msg, 0), cv2.COLOR_BGR2RGB)                
